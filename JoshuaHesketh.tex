...
\cventry{Present\\Nov 2014}{Team Leader - Scala Developer - Security Champion}
{\weblink{http://www.thehutgroup.com}{The Hut}}{Northwich}{Cheshire}{
\begin{itemize}
  \item Design, prototype and developed highly-available, fault-tolerant and reactive green-field project around project with £100M investment.
  \item Functional Scala, Akka, CQRS/ES domain driven design with Cassandra Database, Java 8 Spring Boot with Hazelcast and AWS Dynamo.
  \item AWS IaaS solutions including EC2, S3, Route 53, ELB, VPC, Dynamo, Redshift, Kenesis Firehose, CodeCommit.
