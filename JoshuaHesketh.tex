...
\begin{itemize}
  ...
  \item Designing solutions to client requires while maintaining the integrity of secure reliable products.
...
\begin{itemize}
  ...
  \item Securing websites and webservers against vulnerabilities and any method of exploitation the client would be potentially exposed to.
...
\item public-key cryptography with SHA based encryption algorithms such as PGP/GPG, Truecrypt. I find the more recently implemented proof-of-work aspect of cryptography particulary interesting.
